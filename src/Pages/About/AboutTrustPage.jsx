...
import headerImg from '../../Assets/about/abouttrust.jpg'
  ...
  return (
    <div>
      <div className={`h-[30vh] md:h-[50vh] bg-cover bg-no-repeat bg-center flex justify-center items-end p-5 bg-dark-brown md:shadow-[inset_0px_20px_200px_50px_#49263D] md:bg-[image:var(--image-url)]`}  style={{'--image-url': `url(${headerImg})`}}>
        <div className='p-5 font-lora text-2xl md:text-5xl font-black text-cream'>
          About Trust
        </div>
      </div>
              ...
              {isInViewabouttrust &&
                ...
                >
                  <div className='text-start'>
                    ...
                    <p className='text-4xl leading-snug font-lora text-dark-brown font-black'>Khodaldham Temple Trust</p>
